...
for idx, ftype in enumerate(os.listdir(args.indir)):
	...
	Classifiers["RF"]=(rf_best_clf,rf_disc,rf_fpr,rf_tpr)
	...
	Classifiers["SGD"]=(sgd_best_clf,sgd_disc,sgd_fpr,sgd_tpr)
	...
	Classifiers["kNN"]=(knn_best_clf,knn_disc,knn_fpr,knn_tpr)
	...
	Classifiers["NB"]=(nb_best_clf,nb_disc,nb_fpr,nb_tpr)
	...
	Classifiers["MLP"]=(mlp_best_clf,mlp_disc,mlp_fpr,mlp_tpr)
	...
	Classifiers["SVM"]=(svm_best_clf,svm_disc,svm_fpr,svm_tpr)
